//////////////////////////////////////////////////////////
// This skim has been automatically generated on
// Tue Jul 11 12:27:08 2017 by ROOT version 6.06/01
...
// Header file for the claes stored in the TTree if any.
#include "vector"
#include "TString.h"
...
// used to generate this cla and read the Tree.
   if (tree == 0) {

#ifdef SINGLE_TREE
      // The following code should be used if you want this cla to access
      ...
      // The following code should be used if you want this cla to access a chain
      // of trees.
      TChain * chain = new TChain("ggNtuplizer/EventTree","");
      chain->Add("/eos/uscms/store/user/troy2012/ntuples_2016/ST_s.root/ggNtuplizer/EventTree");
      tree = chain;
#endif // SINGLE_TREE
...
void skim::Init(TTree *tree)
{
   ...
   fSkim = tree->CloneTree(0);
   tree->CopyAddresses(fSkim);
